...
var zh = catalog{
	...
	"err.task.only_failed_retry":         "只有失败或生成中（卡住）的任务才能重试",
	...
	"err.avatar.video_required":          "必须上传视频文件",
	"err.avatar.video_type":              "仅支持 mp4 / mov / webm / mkv / avi 视频格式",
	"err.avatar.video_save_failed":       "保存视频失败：%s",
	"err.avatar.video_not_found":         "视频不存在",
	"err.avatar.video_default":           "系统默认视频不可删除",

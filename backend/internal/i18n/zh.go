...
var zh = catalog{
	...
	"err.tg.not_configured":       "Telegram 登录未配置（缺少 TG_BOT_TOKEN）",
	"err.tg.init_data_required":   "缺少 initData",
	"err.tg.invalid_init_data":    "Telegram 校验失败",
	"err.tg.invalid_user":         "initData 缺少有效的用户信息",
	...
	"err.scene.title_required":           "场景标题为必填项",
	"err.scene.not_found":                "场景不存在",
	"err.scene.default_protected":        "默认场景不可删除",
	"err.scene.default_video_protected":  "默认视频不可删除",
	"err.scene.description_required":     "视频描述不能为空",
	"err.video_gen.unsupported_provider": "暂不支持的视频生成方式：%s",
	"err.video_gen.image_required":       "请上传用于生成视频的形象图片",
	"err.video_gen.dispatch_failed":      "视频生成任务提交失败：%s",
